...
export default function Reports() {
  ...
  const handleDelete = async (e, id) => {
    e.stopPropagation()
    if (!confirm('Are you sure you want to permanently delete this report and its database record?')) return
    setDeletingId(id)
    try {
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
          ...
          <div className="flex justify-between items-end">
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: c.textDim }}>Full history of all deepfake detection database logs.</p>
            </div>
            <button
